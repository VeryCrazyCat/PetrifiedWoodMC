...
public class ModBlocks {
    ...
    public static final Block PETRIFIED_OAK_PLANKS = registerBlock("petrified_oak_planks",
            new Block(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).hardness(2f).requiresTool().mapColor(MapColor.YELLOW).resistance(30f)));

    public static final Block PETRIFIED_OAK_SLAB = registerBlock("petrified_oak_slab",
            new SlabBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).hardness(2f).requiresTool().mapColor(MapColor.YELLOW).resistance(30f)));
    ...
    public static final Block PETRIFIED_CHERRY_PLANKS = registerBlock("petrified_cherry_planks",
            new Block(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).hardness(2f).requiresTool().mapColor(MapColor.YELLOW).resistance(30f)));

    public static final Block PETRIFIED_CHERRY_SLAB = registerBlock("petrified_cherry_slab",
            new SlabBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).hardness(2f).requiresTool().mapColor(MapColor.YELLOW).resistance(30f)));

    public static final Block PETRIFIED_BAMBOO_PLANKS = registerBlock("petrified_bamboo_planks",
            new Block(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).hardness(2f).requiresTool().mapColor(MapColor.YELLOW).resistance(30f)));
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK,new Identifier(PetrifiedWood.MOD_ID, name), block);
    ...
    private static Item registerBlockItem(String name, Block block) {
        Item item = Registry.register(Registries.ITEM, new Identifier(PetrifiedWood.MOD_ID, name),
