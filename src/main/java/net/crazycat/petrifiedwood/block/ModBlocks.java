...
public class ModBlocks {
    ...
    public static final Block PETRIFIED_OAK_PLANKS = registerBlock("petrified_oak_planks",
            new Block(FabricBlockSettings.of(Material.STONE).hardness(2f).requiresTool().mapColor(MapColor.YELLOW).resistance(30f)), ItemGroups.BUILDING_BLOCKS);

    public static final Block PETRIFIED_OAK_SLAB = registerBlock("petrified_oak_slab",
            new SlabBlock(FabricBlockSettings.of(Material.STONE).hardness(2f).requiresTool().mapColor(MapColor.YELLOW).resistance(30f)), ItemGroups.BUILDING_BLOCKS);
